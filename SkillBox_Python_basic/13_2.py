...
# Юра пишет различные полезные функции для Python, чтобы остальным программистам стало проще работать. Он захотел написать функцию, которая будет находить максимум из перечисленных чисел.
...
def maximum_of_two(first, second):
    maximum_of_two = max(first, second)
    maximum_of_three(maximum_of_two, third)

def maximum_of_three(maximum_of_two, third):
    if maximum_of_two> third:
        print(maximum_of_two)
    else:
        print(third)

        
maximum_of_two(first, second)