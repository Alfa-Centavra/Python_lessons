...
mesyac_traty = expenses
for mesyac in range(1, 11):
  print(mesyac, 'месяц траты', mesyac_traty, 'не хватает', summ)
  mesyac_traty += mesyac_traty * 0.03
  mesyac_traty = round(mesyac_traty, 1)
  count = mesyac_traty - expenses
  count -= expenses
  summ += mesyac_traty - educational_grant