...
reverse_timer = int(input('Сколько секунд разогреть еду: '))
for sec in range(reverse_timer, 0, -1):
  prer = int(input('хочет ли он сейчас остановить разогрев или нет? 1 - da/ 0 - net '))
  if prer == 1:
    ...
    continue
if prer == 1:
  print('Ваша еда готова, можете забрать', sec)
else:
